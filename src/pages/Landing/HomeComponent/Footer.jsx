      ...
      <div className="footer-top">
        ...
        <div className="footer-brand">
          ...
          <p className="footer-tagline">
            From Client Chaos to <span className="highlight-text">Creative Clarity.</span>
          </p>
        </div>
        ...
        <div className="footer-links">
          <div className="footer-column">
            ...
            <ul>
              ...
              <li><a href="#why-breifora">Why Breifora</a></li>
      ...
      <div className="footer-watermark">
        <div className="watermark-content">
          {/* <div className="watermark-icon-wrapper">
            <svg viewBox="0 0 24 24" fill="currentColor" className="watermark-icon">
              <path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" />
            </svg>
          </div> */}
